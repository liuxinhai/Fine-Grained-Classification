...
train_path = '/home3/lxh/modelnet/modelnet40v1_2/train/'
train_files = os.listdir(train_path)
train_files.sort()
train_labels = np.load('/home3/lxh/modelnet/modelnet40v1_2/modelnet40_label_train.npy')
...
with tf.Session() as sess:
	...
	saver.restore(sess, './train_models/batch_size_36_epo_30.ckpt')
	for epo in range(epoch):
		...
		for i in range(num_batches):
			...
			saver.save(sess, "./train_models/batch_size_{}_epo_{}.ckpt".format(batch_size, epo+30))
